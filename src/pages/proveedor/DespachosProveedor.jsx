...
function DespachosProveedor() {
    ...
    const cargarDespachos = useCallback(async () => {
        try {
            const data = await obtenerDespachosProveedor();
            setDespachos(data);
        } catch (err) {
    ...
    const handleAnular = async () => {
        ...
        try {
            ...
            setMensajeExito(
                `Despacho #${despachoAnular.id} anulado. La factura volvió a estado pendiente.`
            );
            cerrarModalAnular();
        ...
        <section className="despachos">
            <header className="despachos__header">
                <div>
                    ...
                    <p className="despachos__subtitulo">
                        Envíos generados a partir de tus facturas despachadas
                    </p>
                </div>
            </header>
            ...
            {cargando ? (
                ...
                <Card className="despachos__vacio">
                    ...
                    <p>
                        Cuando despaches una factura pendiente, el envío
                        aparecerá aquí.
                    </p>
                </Card>
            ) : (
                            ...
                            <tbody>
                                {despachos.map((despacho) => (
                                    <tr key={despacho.id}>
                                        ...
                                        <td>
                                            {despacho.Factura?.usuarioVendedor
                                                ?.nombre ?? "—"}
                                        </td>
                                        <td>
            ...
            >
                ...
                <p className="factura-form__texto">
                    ¿Anular el despacho de la factura{" "}
                    <strong>#{despachoAnular?.factura}</strong>? La factura
...
export default DespachosProveedor;
