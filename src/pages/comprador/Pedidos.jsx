...
function Pedidos() {
    ...
    const cargarPedidos = useCallback(async () => {
        try {
            const data = await obtenerDespachosComprador();
            setPedidos(data);
        } catch (err) {
    ...
    const handleRecibir = async () => {
        ...
        try {
            ...
            setMensajeExito(`Pedido #${pedidoRecibir.id} recibido`);
            cerrarModalRecibir();
            await cargarPedidos();
        } catch (err) {
        ...
        <section className="pedidos">
            ...
            {cargando ? (
                ...
                <Card className="pedidos__vacio">
                    ...
                    <p>
                        Cuando un vendedor despache una de tus compras, el
                        envío aparecerá aquí.
                    </p>
                </Card>
            ) : (
                <Card>
                            ...
                            <tbody>
                                {pedidos.map((pedido) => (
                                    <tr key={pedido.id}>
                                        ...
                                        <td>
                                            {pedido.Factura?.usuarioVendedor
                                                ?.nombre ?? "—"}
                                        </td>
            ...
            >
                ...
                <p className="factura-form__texto">
                    ¿Confirmas la recepción de tu compra a{" "}
                    <strong>
                        {pedidoRecibir?.Factura?.usuarioVendedor?.nombre ??
                            "tu vendedor"}
                    </strong>
                    ? La factura pasará a <strong>Recibida</strong>.
                </p>
